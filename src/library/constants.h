...
name const & get_blast_arith_cheat_nonzero_name();
name const & get_blast_arith_neg_congr_name();
name const & get_blast_arith_neg_num_mul_name();
name const & get_blast_arith_neg_mul_one_name();
name const & get_blast_arith_neg_add_name();
name const & get_blast_arith_inv_inv_name();
name const & get_blast_arith_inv_mul_name();
name const & get_blast_arith_inv_mul_one_name();
name const & get_blast_arith_inv_congr_name();
name const & get_blast_arith_mul_inv_cancel_name();
name const & get_blast_arith_mul_congr_name();
name const & get_blast_arith_mul_congr_right_name();
name const & get_blast_arith_mul_congr_right_rec_name();
name const & get_blast_arith_mul_congr_rec_name();
name const & get_blast_arith_mul_assoc_name();
name const & get_blast_arith_mul_insert_flat_name();
name const & get_blast_arith_mul_insertion_sort_name();
name const & get_blast_arith_mul_cancel_one_right_name();
name const & get_blast_arith_mul_fuse_left_name();
name const & get_blast_arith_mul_cancel_left_name();
name const & get_blast_arith_mul_distrib_right_name();
name const & get_blast_arith_mul_distrib_left_name();
name const & get_blast_arith_mul_distrib_both_name();
name const & get_blast_arith_one_mul_rev_name();
name const & get_blast_arith_add_congr_name();
name const & get_blast_arith_add_congr_right_name();
name const & get_blast_arith_add_congr_right_rec_name();
name const & get_blast_arith_add_assoc_name();
name const & get_blast_arith_add_assoc_rev_name();
name const & get_blast_arith_add_sort_right_name();
name const & get_blast_arith_add_insertion_sort_name();
name const & get_blast_arith_add_insert_flat_name();
name const & get_blast_arith_add_cancel_zero_right_name();
name const & get_blast_arith_add_fuse_name();
name const & get_blast_arith_add_fuse_left_name();
name const & get_blast_arith_add_fuse_num_name();
name const & get_blast_arith_add_fuse_num_left_name();
name const & get_blast_arith_add_fuse_zero_name();
name const & get_blast_arith_add_fuse_num_zero_left_name();
name const & get_blast_arith_add_fuse_zero_left_name();
...
name const & get_division_def_name();
name const & get_division_ring_inv_inv_name();
...
name const & get_mul_assoc_name();
name const & get_mul_one_name();
name const & get_mul_comm_name();
name const & get_mul_inv_cancel_name();
name const & get_mul_right_inv_name();
...
name const & get_norm_num_inv_of_div_helper_name();
name const & get_norm_num_eq_inv_of_eq_div_helper_name();
name const & get_norm_num_eq_mulinv_of_eq_div_helper_name();
name const & get_norm_num_mulinv_ne_zero_of_ne_zero_ne_zero_name();
name const & get_norm_num_neg_congr_name();
...
name const & get_one_div_eq_inv_name();
...
name const & get_ordered_arith_neg_nonzero_of_nonzero_name();
...
name const & get_ordered_arith_zero_lt_of_lt_name();
name const & get_ordered_arith_zero_le_of_le_name();
name const & get_ordered_arith_zero_le_of_eq1_name();
name const & get_ordered_arith_zero_le_of_eq2_name();
name const & get_ordered_arith_mulinv_pos_of_pos_pos_name();
name const & get_ordered_arith_inv_pos_of_pos_name();
