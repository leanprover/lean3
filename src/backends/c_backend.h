...
namespace lean  {
    ...
    public:
        ...
        virtual name generate_simple_expr(std::ostream& os, simple_expr const & se);
        void generate_ctor(std::ostream& os, ctor const & c);
        void generate_binding(std::ostream& os, pair<name, shared_ptr<simple_expr>> & p);
        name generate_simple_expr_let(std::ostream& os, simple_expr const & se);
        name generate_simple_expr_switch(std::ostream& os, simple_expr const & se);
        name generate_simple_expr_call(std::ostream& os, simple_expr const & se);
